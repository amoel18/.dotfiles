...
alias tex='tmux new-session \; send-keys  cd\ $LATEX C-m \; send-keys clear C-m \;  select-pane -t 1 \; split-window -v -p 30\; send-keys cd\ $LATEX C-m \; send-keys clear C-m \; select-pane -t 1 \; send-keys ls\ $LATEX C-m\;'
alias matlab='./.matlab/MATLAB/R2020b/bin/matlab'
alias nv='nvim $HOME/README.md'
alias packer='.local/share/nvim/site/pack/packer'
alias t='tmux'
